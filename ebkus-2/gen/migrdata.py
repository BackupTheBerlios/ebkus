##########################################################################
# Enthält die Default-Daten, welche nach der Generierung in die Datenbank
# eingelesen werden.
#
...
1;ältestes Kind;fsgr
2;mittleres Kind;fsgr
3;jüngstes Kind;fsgr
4;Einzelkind;fsgr
5;Zwillinge;fsgr
...
18;Schriftliche Arbeit für Klienten;fsle
