"""
Tabellen fuer EB-Klientenverwaltung
...
jahr, INT, Jahr, p,
stz, INT, Dienststelle, k, stzei, default ist aktuelle Dst. des Falles, wird beötigt wegen standalone Funktion der Fachstatistik
bz, INT, Region, k, fsbz
gs, INT, Geschlecht, k, gs
ag, INT, Altersgruppe Kind, k, fsag
fs, INT, Familienstatus (lebt bei), k, fsfs
zm, INT, Zugangsart, k, fszm
ep, INT, Psychotherapieerfahrung, k, fsep
ka, INT, Kinderanzahl, b, fska
gr, INT, Geschwisterreihe, k, fsgr
...
sd, INT, Finanzieller Druck, k, fssd
ba1, INT, Problemlage 1 bei der Anmeldung, k, fsba
ba2, INT, Problemlage 2 bei der Anmeldung, k, fsba
pbe, INT, Hauptproblematik Eltern, k, fspbe
pbk, INT, Hauptproblematik Kind/Jugendliche, k, fspbk
bg, INT, Beendigungsgrund, k, fsbg
kat, INT, Terminanzahl, b, fskat
kkm, INT, Kontaktanzahl Mutter, b, fskat
kkv, INT, Kontaktanzahl Vater, b, fskat
kki, INT, Kontaktanzahl Kind, b, fskat
kpa, INT, Kontaktanzahl Paar, b, fskat
kfa, INT, Kontaktanzahl Familie, b, fskat
ksoz, INT, Kontaktanzahl Sozialarbeiter, b, fskat
kleh, INT, Kontaktanzahl Lehrer, b, fskat
kerz, INT, Kontaktanzahl Erzieher, b, fskat
...
rbz, INT, Regierungsbezirk, k, rbz
kr, INT, Kreis, k, kr
gm, INT, Gemeinde, k, gm
gmt, INT, Gemeindeteil, k, gmt
