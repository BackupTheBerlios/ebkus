...
class Akte(DBObjekt):
  table = 'akte'
  fields =  ['id', 'vn', 'na', 'gb', 'ber', 'str', 'plz', 'ort', \
...
class Bezugsperson(DBObjekt):
  table = 'bezugsperson'
  fields =  ['id', 'akte_id', 'vn', 'na', 'gb', 'ber', 'str', 'plz', \
                       'ort', 'tl1', 'tl2', 'fs', 'verw', 'no', 'nobed', 'vrt']
  fieldtypes = {}
  foreignfieldtypes = {}
  inversefieldtypes = {}
  attributemethods = {}
...
class Fachstatistik(DBObjekt):
  ...
  fields =  ['id', 'mit_id', 'fall_id', 'fall_fn', 'jahr', 'stz', \
                       'bz', 'gs', 'ag', 'fs', 'zm', 'ep', 'ka', 'gr', 'hkm', \
                       'hkv', 'bkm', 'bkv', 'agkm', 'agkv', 'sd', 'ba1', 'ba2', \
                       'pbe', 'pbk', 'bg', 'kat', 'kkm', 'kkv', 'kki', 'kpa', \
                       'kfa', 'ksoz', 'kleh', 'kerz', 'kson', 'no', 'no2', \
                       'no3', 'zeit']
  fieldtypes = {}
  foreignfieldtypes = {}
  inversefieldtypes = {}
...
Fachstatistik.foreignfieldtypes['bz'] = (Code, None)
...
Fachstatistik.foreignfieldtypes['ep'] = (Code, None)
Fachstatistik.foreignfieldtypes['gr'] = (Code, None)
...
Fachstatistik.foreignfieldtypes['sd'] = (Code, None)
...
Fachstatistik.foreignfieldtypes['bg'] = (Code, None)
